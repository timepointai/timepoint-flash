...
echo -e "${NC}"
echo -e "${GREEN}Starting TIMEPOINT Flash Server v2.2.1${NC}"
echo ""
...
echo -e "  Gemini3:  Gemini 3 Flash Preview via OpenRouter (latest thinking model)"
echo ""
echo -e "${GREEN}Image Fallback Chain:${NC}"
echo -e "  1. Google Imagen → 2. OpenRouter Flux → 3. Pollinations.ai (free, never fails)"
echo ""
